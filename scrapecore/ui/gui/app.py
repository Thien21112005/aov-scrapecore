"""
Modern Graphical User Interface (GUI) for AOV ScrapeCore
Using CustomTkinter for a sleek, responsive dark-themed desktop interface.
"""
...
class AOVDownloaderGUI(ctk.CTk):
    def __init__(self):
        ...
        self.title("AOV ScrapeCore - Tool Tải Ảnh & Kỹ Năng Tướng Full HD")
        self.geometry("980x720")
        self.minsize(850, 600)

        self.scraper = ScraperService()
        self.downloader = DownloadService(self.scraper)
        self.all_heroes = []
    ...
    def _start_download(self):
        ...
        def worker():
            ...
            results = self.downloader.download_heroes_batch(
